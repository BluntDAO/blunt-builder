      ...
      <div className="w-full flex flex-col justify-center items-center gap-0">
        <div className="bg-white w-full flex justify-center pt-8">
          <div className="max-w-[720px] px-6 w-full flex flex-col gap-4 [&>p]:text-secondary">
            <h2>The Global Treasury for Seshes</h2>
            <p>
              ...
              million, 1 blunt/sesh at a time. For 2+ years we have been doing
              BluntDAO (also JointsDAO & SpliffDAO) for free. Nowin year 3: we
              are on the path to scale: unlimited sesh. A replenishing treasury
              for holders to vote on global requests for sesh.
            </p>
            ...
            <h2 className="pt-4">Background</h2>
            <p>
              Over 2 years ago, we started started on Solana, with a simple
              mission, lets give a NFT to everyone we smoke with IRL and call it
              ...
              validators, creating more OG validators. We expanded to more than
              ...
              everyone is high. This is why in year 3, we are on the path to
              scale: unlimited sesh. A replenishing treasury for holders to vote
              on global requests for sesh.is essence this is what BluntDAO is
              living up to. The mission to make sure blunts get smoked. And we
              use blockchain for stuff.
            </p>
            <Image
              src="/blunts-3.jpg"
              width={"500"}
